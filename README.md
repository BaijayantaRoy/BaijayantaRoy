...
✍️ [baijayanta.medium.com](https://baijayanta.medium.com/) — AI strategy, agentic systems, payment infrastructure
💼 [linkedin.com/in/baijayantaroy](https://www.linkedin.com/in/baijayantaroy) — where I publish most


<details>
<summary>Earlier work (reference)</summary>

- [Medium-Article](https://github.com/BaijayantaRoy/Medium-Article) — algorithm implementations for early Medium articles (A* search)
- [GenAI-LLM-Learning-Series-Track1](https://github.com/BaijayantaRoy/GenAI-LLM-Learning-Series-Track1) — LLM foundations from scratch, YouTube companion
